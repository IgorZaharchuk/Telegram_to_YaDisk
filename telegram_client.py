...
from telethon import TelegramClient, functions  # 👈 ТОЛЬКО ТАК!
...
class TelegramDownloader:
    ...
    def get_topic_id_from_message(self, message):
        ...
        Источник: https://stackoverflow.com/questions/79157818/ [citation:2]
        """
    ...
    async def get_topic_name(self, chat_id: int, topic_id: int) -> str | None:
        ...
        Официальная документация: https://tl.telethon.dev/methods/channels/get_forum_topics_by_id.html [citation:1]
        """
        try:
            ...
            # ПРАВИЛЬНЫЙ ВЫЗОВ ИЗ ДОКУМЕНТАЦИИ
